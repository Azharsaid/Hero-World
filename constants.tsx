...
// GitHub Pages base (because you use base: "/Hero-World/" in vite.config.ts)
const BASE = import.meta.env.BASE_URL;

// Anything inside /public is served from the site root (not /public/) :contentReference[oaicite:1]{index=1}
...
// --------------------
// Games (IMPORTANT: must include game.type for GameView routing)
// --------------------
export const GAMES: Game[] = [
  ...
  // More games your GameView already supports:
  {
    id: 'alphabet',
  ...
  {
    id: 'sudoku',
    type: GameType.LOGIC, // GameView checks id === 'sudoku'
    icon: '🔲',
    color: 'bg-green-700',
...
// --------------------
// Soundtracks (your local 1.mp3 .. 22.mp3)
// --------------------
export const SOUNDTRACKS: Soundtrack[] = Array.from({ length: 22 }).map((_, i) => {
  const n = i + 1;
  return {
    id: `track_${n}`,
    name: { en: `Track ${n}`, ar: `مقطوعة ${n}` },
    url: track(`${n}.mp3`),
  };
});
